...
<table id="Table2" align="center" 
        ...
        <td align="right" height="25">
         ...
         <tr>
            ...
            <asp:TextBox ID="TextBox1" runat="server" ReadOnly="false" onclick="showCal(this, event)"></asp:TextBox>
              
               <td align="right"  >
                   <asp:Label ID="Label12" runat="server" ForeColor="Black" Text="Secrect Key :"></asp:Label>
