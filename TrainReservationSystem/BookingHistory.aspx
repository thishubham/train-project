<%@ Page Title="" Language="C#" MasterPageFile="~/User.master" AutoEventWireup="true" CodeFile="BookingHistory.aspx.cs" Inherits="BookingHistory" %>
...
<h1><u>Booking History</u></h1>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [trainBooking] WHERE ([username] = @username)">
        <SelectParameters>
