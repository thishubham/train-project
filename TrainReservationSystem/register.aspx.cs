...
public partial class register : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        try
        {
            ...
            con.open_connection();
            string str = "insert into registration values('" + txtID.Text + "','" + txtEmail.Text + "','" + txtFname.Text + "','" + txtLName.Text + "','" + radGen.Text + "','" + txtFather.Text + "','" + txtPass.Text + "','" + dob + "','" + txtAdd.Text + "','" + txtCity.Text + "','" + txtState.Text + "','" + txtPostal.Text + "','" + txtCountry.Text + "','" + txtPone.Text + "','" + System.DateTime.Now.ToString() + "','"+Image1.ImageUrl+"','"+utype+"','"+txtAge.Text+"')";
            SqlCommand cmd = new SqlCommand(str, con.con_pass());
            cmd.ExecuteNonQuery();
            con.close_connection();
            con.open_connection();
            string st = "insert into login values('" + txtEmail.Text + "','" + txtPass.Text + "','" + utype + "')";
